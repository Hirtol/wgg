...
export type ViewerInfoQuery = {
    __typename?: 'QueryRoot';
    viewer: { __typename?: 'AuthContext'; id: number; email: string; username: string; isAdmin: boolean };
};
...
export type GetAllPromotionsQuery = {
    ...
    proSearchAll: Array<{
        ...
        provider: Provider;
        displayPrice: number;
        unitQuantity: { __typename?: 'UnitQuantity'; unit: Unit; amount: number };
    }>;
};
...
export type SubmitLoginMutation = {
    __typename?: 'MutationRoot';
    login: {
        __typename?: 'UserLoginPayload';
        user: { __typename?: 'AuthContext'; id: number; email: string; username: string; isAdmin: boolean };
    };
};

export const ViewerContextFragmentDoc = {
    kind: 'Document',
    definitions: [
        {
            kind: 'FragmentDefinition',
            name: { kind: 'Name', value: 'ViewerContext' },
            typeCondition: { kind: 'NamedType', name: { kind: 'Name', value: 'AuthContext' } },
            selectionSet: {
                kind: 'SelectionSet',
                selections: [
...
} as unknown as DocumentNode<ViewerContextFragment, unknown>;
    ...
    definitions: [
        {
            kind: 'OperationDefinition',
            operation: 'query',
            name: { kind: 'Name', value: 'ViewerInfoQuery' },
            selectionSet: {
                kind: 'SelectionSet',
                selections: [
                    {
                        ...
                        selectionSet: {
                            kind: 'SelectionSet',
                            selections: [{ kind: 'FragmentSpread', name: { kind: 'Name', value: 'ViewerContext' } }]
                        }
                    }
                ]
            }
        },
        ...ViewerContextFragmentDoc.definitions
    ]
} as unknown as DocumentNode<ViewerInfoQuery, ViewerInfoQueryVariables>;
    ...
    definitions: [
        {
            ...
            selectionSet: {
                ...
                selections: [
                    {
                        kind: 'Field',
                        name: { kind: 'Name', value: 'proSearchAll' },
                        arguments: [
                            {
                                kind: 'Argument',
                                name: { kind: 'Name', value: 'query' },
                                value: { kind: 'StringValue', value: 'banaan', block: false }
                            }
                        ],
                        selectionSet: {
                            kind: 'SelectionSet',
                            selections: [
                                ...
                                {
                                    kind: 'Field',
                                    name: { kind: 'Name', value: 'unitQuantity' },
                                    selectionSet: {
                                        kind: 'SelectionSet',
                                        selections: [
...
} as unknown as DocumentNode<GetAllPromotionsQuery, GetAllPromotionsQueryVariables>;
export const SubmitLoginDocument = {
    kind: 'Document',
    definitions: [
        {
            kind: 'OperationDefinition',
            operation: 'mutation',
            name: { kind: 'Name', value: 'submitLogin' },
            variableDefinitions: [
                {
...
} as unknown as DocumentNode<SubmitLoginMutation, SubmitLoginMutationVariables>;
